 ...
 */
FARPROC WINAPI serial_GUI_noICTDelayLoadWin32FailureHook (unsigned dliNotify, PDelayLoadInfo pdli)
{
...
PfnDliHook __pfnDliFailureHook2 = serial_GUI_noICTDelayLoadWin32FailureHook;
#else
PfnDliHook __pfnDliFailureHook = serial_GUI_noICTDelayLoadWin32FailureHook;
#endif
