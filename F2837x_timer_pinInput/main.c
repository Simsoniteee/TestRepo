...
// Project: F2837x_timer_pinInput
// Author: Simon
// Date: 07.08.2017
// Revison:
// Info: read input pin GPIO16 (pin 33 jumper 4 on launchpad)every second and show it by global variable pinValue
...
/*     GPIO_setPinConfig(DEVICE_GPIO_PIN_LED1);
     ...
     GPIO_setDirectionMode(16, GPIO_DIR_MODE_IN);     // GPIO16 = input
